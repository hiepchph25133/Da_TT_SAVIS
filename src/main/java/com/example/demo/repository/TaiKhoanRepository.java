...
public interface TaiKhoanRepository extends JpaRepository<TaiKhoan, UUID> {
    ...
    TaiKhoan findByAcc(@Param("tenTaiKhoan")String tenTaiKhoan,@Param("matKhau")String matKhau);

    Optional<TaiKhoan> findByTenTaiKhoan(String tk);

    boolean existsByTenTaiKhoanAndMatKhau(String tentk, String matKhau);
    boolean existsByTenTaiKhoan(String tentk);
}
