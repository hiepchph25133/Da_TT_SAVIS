...
//    }
    ...
    public String viewAdd(Model model) {
        ...
        model.addAttribute("listOfRoles", vaiTroService.getAll());
        return "/nhanvien/add";
    }
...
//    @PostMapping("/add")
//    public String add(@Valid @ModelAttribute("USER") TaiKhoan taiKhoan, BindingResult result, Model model) {
//        if (result.hasErrors()) {
//            return "/nhanvien/add.html";
//        }
//
//        // Kiểm tra xem vaiTro đã được set chưa
//        if (taiKhoan.getVaiTro() == null) {
//            // Nếu chưa, set giá trị mặc định là "USER"
//            VaiTro defaultVaiTro = new VaiTro();
//            defaultVaiTro.setTenVaiTro("USER");
//            taiKhoan.setVaiTro(defaultVaiTro);
//        }
//
//        Date date = new Date();
//        taiKhoan.setNgayTao(date);
